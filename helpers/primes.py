...
class RangeFactor:
    ...
    def areCoprime(self, n, m):
        ...
        P = set(self.factors[m].keys()).intersection(set(self.factors[n].key))
        if len(P)==0: return True
        return False


# Taken from http://stackoverflow.com/questions/23287/largest-prime-factor-of-a-number/412942#412942
def prime_factors(n):
    """
